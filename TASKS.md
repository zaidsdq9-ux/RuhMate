...
- [2026-05-27] Vercel Hobby plan rejects deploys when commit author email doesn't match the Vercel account login. Set per-repo `git config user.email zaidsdq9@gmail.com` (matches Vercel login). Global git config untouched.
